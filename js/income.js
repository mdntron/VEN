...
async function onDisconnect() {
 ...
 async  function getwithdraw(withdrawaddress,withdrawindex){
 	 console.log('getwithdraw');
 	  ...
 	  var helloResult =  await currentContract.methods.withdraw_history(withdrawaddress,withdrawindex).call({from:selectedAccount}).then(function(result){
 ...
 async  function getuser(useraddress){
 	console.log('onusers');
 	 var helloResult =  await currentContract.methods.users(useraddress).call({from:selectedAccount}).then(function(result){
